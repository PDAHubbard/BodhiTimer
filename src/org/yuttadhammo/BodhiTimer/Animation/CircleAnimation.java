...
class CircleAnimation implements TimerAnimation.TimerDrawing
{
	...
	{	
		...
		switch(theme){
			...
			case 3:
			default:
				colors = new int[] { resources.getColor(R.color.themeD1),
						 resources.getColor(R.color.themeD2),
						 resources.getColor(R.color.themeD3),
						 resources.getColor(R.color.themeD4),
						 resources.getColor(R.color.themeD5)
				};
				break;				
		}
